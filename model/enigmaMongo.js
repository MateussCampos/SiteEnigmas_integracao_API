  ...
  async inserirEnigmas() {
    const enigmas = [
      ...
      },
      {
        ...
        enigma:
          "Uma mulher salta do parapeito da janela do sexto andar. No entanto, não morre nem sofre quaisquer lesões.",
        resposta:
      ...
      },
      {
        ...
        enigma:
          "João sai em uma viagem com sua bússola. Depois de uma longa caminhada, ele para para comer um sanduíche. Depois disso ele não consegue encontrar o caminho de volta.",
        resposta:
          "João era um cientista que trabalhava perto do Polo Norte. Quando andava, caminhou para o norte, e parou para comer seu sanduíche precisamente no Polo Norte. Quando ele tentou voltar, sua bússola era inútil, já que todas as direções apontavam para o sul.",
        nivel: "fácil",
      },
      {
        dataInsercao: "2025-08-03T17:13:16.417844Z",
        enigma:
          "Um homem vai ao médico para saber os resultados de alguns exames. Os resultados não mostram problemas de saúde. No entanto, ele comete suicídio logo após a visita.",
        resposta:
          "O paciente sabia que sua esposa estava traindo-o, mas ele só sabia o nome do amante. Sua esposa jurou-lhe que esse amante não existia. No entanto, quando o homem saiu do médico, ele viu o nome do amante no relatório. O homem percebeu que sua esposa estava traindo-o com seu médico e não conseguiu lidar com isso.",
        nivel: "difícil",
      },
      {
      ...
      },
      {
        ...
        resposta:
          "Ele estava navegando no Mar Morto. Devido à enorme concentração de sal, ele não conseguiu afundar o suficiente para obter o relógio.",
        nivel: "fácil",
      },
      {
      ...
      },
      {
        ...
        enigma: "O que é que quanto mais se espalha, mais aumenta?",
        resposta: "Notícia.",
        nivel: "difícil",
      },
      {
      ...
      },
      {
        ...
        enigma:
          "Vanessa era amada por todos que a conheciam e não possuía inimigos. Apesar disso, muitas pessoas ficaram felizes com sua morte.",
        resposta:
      ...
      },
      {
        ...
        enigma:
          "Um pirata enterra seu maior tesouro numa ilha deserta. Após um tempo, ele descobre que um de seus rivais conseguiu uma cópia do mapa que mostra o local do tesouro, mas não se incomoda.",
        resposta:
      ...
      },
      {
        ...
        enigma:
          "Uma mulher caminha pela selva, vê uma pedra e percebe que há uma folha de papel em branco sobre ela. Ela se deita e chora.",
        resposta:
      ...
      },
      {
        ...
        enigma:
          "Um rapaz vai para a farmácia e rapidamente sai dela com o dinheiro do caixa. O dono da farmácia chama a polícia e, algum tempo depois, um policial recupera o dinheiro e leva o rapaz com él. Naquela noite, as três pessoas vão à delegacia para relatar um roubo.",
        resposta:
          "O rapaz era filho do dono da farmácia. Seu carro tinha sido roubado e ele tinha um exame importante. Ele estava na farmácia para pedir à mãe algum dinheiro para ele pegar um táxi. Além disso, a mãe chama o marido, que era um policial, e pediu-lhe que levasse seu filho para a consulta. Depois disso tudo, a família relata o roubo do carro.",
        nivel: "difícil",
      },
      {
      ...
      },
      {
        ...
        enigma:
          "Gabriel invade a casa de Alexandre para matá-lo, mas não o faz. No entanto, Gabriel é imediatamente preso e condenado pelo crime.",
        resposta:
      ...
      },
      {
        ...
        resposta:
          "O homem ganhou na loteria. Ele pede demissão e comemora com os amigos. No dia seguinte ele se veste para resgatar o prêmio, mas percebe que o bilhete foi destruído ao lavar seu terno alguns dias antes.",
        nivel: "difícil",
      },
      {
      ...
      },
      {
        ...
        enigma: "Um homem morre no natal após receber um SMS",
        resposta:
      ...
      },
      {
        ...
        resposta:
          "Victor e Mateus fizeram uma aposta. Foi acordado que o vencedor poderia destruir o carro do perdedor. Victor perdeu a aposta.",
        nivel: "médio",
      },
